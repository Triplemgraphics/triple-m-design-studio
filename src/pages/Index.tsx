        ...
        <div className="container mx-auto px-4">
          <div className="max-w-6xl mx-auto">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center mb-16">
              <div>
                <h3 className="text-2xl font-playfair font-bold mb-6 text-foreground">Our Story</h3>
            ...
            <div className="bg-card rounded-lg p-8">
              <h3 className="text-2xl font-playfair font-bold mb-6 text-center text-foreground">Why Choose Us?</h3>
